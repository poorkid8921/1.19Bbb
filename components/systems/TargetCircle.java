...
import net.onyx.client.utils.Render2DUtils;
...
public class TargetCircle {
    ...
    public double getRadius() {
        return fov * OnyxClient.getClient().getWindow().getScaledWidth() / OnyxClient.getClient().options.getFov().getValue();
    }
    ...
    public Iterable<Entity> getEntities() {
        ...
        for (Entity entity : OnyxClient.getClient().world.getEntities()) {
            if (entity == OnyxClient.me()) continue;
