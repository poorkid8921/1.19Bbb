...
public class TimerCheck extends Check implements PacketCheck {
    ...
    public void doCheck(final PacketReceiveEvent event) {
        ...
        final boolean failsAdjusted = transactionPing >= 1000 && (timerBalanceRealTime + ((transactionPing * 1e6) - clockDrift - 50e6)) > System.nanoTime();
    ...
    public boolean shouldCountPacketForTimer(PacketTypeCommon packetType) {
        ...
        return WrapperPlayClientPlayerFlying.isFlying(packetType) && !player.packetStateData.lastPacketWasTeleport && !player.packetStateData.lastPacketWasOnePointSeventeenDuplicate;
    }

    @Override
    public void reload() {
        super.reload();
        clockDrift = 120000000L;
    }
}
