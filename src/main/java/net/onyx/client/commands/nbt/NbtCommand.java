package net.onyx.client.commands.nbt;
...
import net.onyx.client.utils.NbtUtils;
...
public class NbtCommand extends CommandNode {
    ...
    public static abstract class NbtModCommand extends Command {
        ...
        protected ItemStack heldItem() {
            return OnyxClient.me().getMainHandStack();
        }
    ...
    public static class NbtSet extends NbtModCommand {
        ...
        public Boolean trigger(String[] args) {
            ...
            try {
                ...
                this.displayChatMessage(String.format("%sERROR: %s", ChatUtils.RED, e));
                return true;
            }
