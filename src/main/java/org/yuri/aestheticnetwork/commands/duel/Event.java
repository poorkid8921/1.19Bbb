...
public class Event implements CommandExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        TextComponent hi = new TextComponent(translate("&7ᴡɪɴɴᴇʀ #fc282f» " + (arg.equals("y") ? "ɴᴏʙᴏᴅʏ" : args[5])));
        if (arg.equals("n"))
        ...
        if (args[9].equals("0")) sender.sendMessage(translate("&7ʟᴇɢᴀᴄʏ #fc282f» ʏᴇs"));
